function EmptyDetailsState() {
  return (
    <section className="details-panel empty-details-panel" aria-label="Job details">
...
function LoadingDetailsState() {
  return (
    <section className="details-panel empty-details-panel" aria-label="Job details">
      ...
      <p className="details-copy">
        Waiting for the selected listing so its full description and metadata can
        be shown.
      </p>
    </section>
  );
...
export function JobDetailsPanel({ isLoading = false, isSaved, job, onToggleSavedJob }) {
  if (isLoading) {
  ...
  return (
    <section className="details-panel" aria-label="Job details">
      ...
      <div className="details-section">
        ...
        <ul className="tag-list details-tag-list" aria-label="Selected job tags">
          {job.tags.map((tag) => (
